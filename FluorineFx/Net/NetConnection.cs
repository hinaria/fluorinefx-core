...
namespace FluorineFx.Net
{
    ...
    public sealed class NetConnection
    {
        ...
        /// <param name="state"></param>
        /// <returns></returns>
        /// <remarks>This method overload enables the TaskFactory to create a Task using FromAsync()</remarks>
        public IAsyncResult BeginConnect(string command, AsyncCallback callback, object state)
        {
            return BeginConnect(command, callback, state, null);
        }
        ...
        private void Connect()
        {
            ...
            if (_uri.Scheme == "rtmp" || _uri.Scheme == "rtmps")
            {
